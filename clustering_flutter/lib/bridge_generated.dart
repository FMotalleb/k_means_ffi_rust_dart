...
abstract class ClusteringFfiRust {
  Future<List<ClusteringResultStruct>> kmeans(
      {required List<PointStruct> points,
...
class ClusteringFfiRustImpl extends FlutterRustBridgeBase<ClusteringFfiRustWire>
    implements ClusteringFfiRust {
  factory ClusteringFfiRustImpl(ffi.DynamicLibrary dylib) =>
      ClusteringFfiRustImpl.raw(ClusteringFfiRustWire(dylib));

  ClusteringFfiRustImpl.raw(ClusteringFfiRustWire inner) : super(inner);
  ...
  Future<List<ClusteringResultStruct>> kmeans(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_kmeans(port_,
            _api2wire_list_point_struct(points), _api2wire_usize(outputCount)),
  ...
  Future<List<ClusteringResultStruct>> optics(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_optics(
            port_,
            _api2wire_list_point_struct(points),
            _api2wire_f64(eps),
  ...
  ffi.Pointer<wire_list_point_struct> _api2wire_list_point_struct(
      List<PointStruct> raw) {
  ...
  void _api_fill_to_wire_point_struct(
      PointStruct apiObj, wire_PointStruct wireObj) {
...
List<ClusteringResultStruct> _wire2api_list_clustering_result_struct(
    dynamic raw) {
  return (raw as List<dynamic>)
      .map(_wire2api_clustering_result_struct)
      .toList();
}
...
/// generated by flutter_rust_bridge
class ClusteringFfiRustWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  ClusteringFfiRustWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ClusteringFfiRustWire.fromLookup(
  ...
  late final _wire_kmeansPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_list_point_struct>,
              uintptr_t)>>('wire_kmeans');
  late final _wire_kmeans = _wire_kmeansPtr.asFunction<
      void Function(int, ffi.Pointer<wire_list_point_struct>, int)>();
  ...
  late final _wire_optics = _wire_opticsPtr.asFunction<
      void Function(int, ffi.Pointer<wire_list_point_struct>, double, int)>();
  ...
  late final _new_list_point_struct_0Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_list_point_struct> Function(
              ffi.Int32)>>('new_list_point_struct_0');
  late final _new_list_point_struct_0 = _new_list_point_struct_0Ptr
      .asFunction<ffi.Pointer<wire_list_point_struct> Function(int)>();
